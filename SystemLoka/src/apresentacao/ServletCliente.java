...
public class ServletCliente extends HttpServlet 
{
	...
	{/*
		...
		try{
			...
			redireciona = request.getRequestDispatcher("cliente/JspExcluir.jsp");
	...
	private void validarExclusao(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher redir = null;
		...
		try {	
			ClienteDTO cliente = new ClienteDTO(nome, cpf, end, cep);
			negocio.excluir(cliente.getCpf());
